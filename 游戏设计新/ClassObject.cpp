...
vector<shared_ptr<Object>> ObjectPool1 = { // 初级藏品
    ...
    make_shared<Object>(1, "M", "D", "Schutz：防御力+50%", 0.5),
    make_shared<Object>(1, "M", "H", "Leben：生命上限+50%", 0.5),
    make_shared<Object>(1, "M", "HE", "Labung：每点治疗能量治疗效果+3%", 0.03),
...
vector<shared_ptr<Object>> ObjectPool2 = { // 中级藏品
    ...
    make_shared<Object>(2, "M", "D", "Schild：防御力+80%", 0.8),
    make_shared<Object>(2, "M", "H", "Vitalitaet：生命上限+100%", 1),
    make_shared<Object>(2, "M", "HE", "Wohl：每点治疗能量治疗效果+6%", 0.06),
...
vector<shared_ptr<Object>> ObjectPool3 = { // 高级藏品
    ...
    make_shared<Object>(3, "M", "D", "Ruestung：防御力+100%", 1),
    make_shared<Object>(3, "M", "H", "Gedeihen：生命上限+150%", 1.5),
    make_shared<Object>(3, "M", "HE", "Wunder：每点治疗能量治疗效果+10%", 0.1),
